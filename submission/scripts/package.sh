...
cp "${DOCS_DIR}/design.md" "${DIST_DIR}/docs/design.md"
cp "${DOCS_DIR}/performance.md" "${DIST_DIR}/docs/performance.md"
cp "${DOCS_DIR}/optimization_principles.md" "${DIST_DIR}/docs/optimization_principles.md"
cp "${DOCS_DIR}/roadmap.md" "${DIST_DIR}/docs/roadmap.md"
cp "${DOCS_DIR}/engineering_log.md" "${DIST_DIR}/docs/engineering_log.md"
cp "${DOCS_DIR}/technical_scheme_notes.md" "${DIST_DIR}/docs/technical_scheme_notes.md"
cp -R "${DOCS_DIR}/benchmark_results" "${DIST_DIR}/docs/benchmark_results"
